...
parser = JsonOutputToolsParser(return_id=True) #Returns the function call from llm and transforms it into a dict
parser_pydantic = PydanticToolsParser(tools=[AnswerQuestion]) #Returns response from llm, searches for function-calling invocation, and transforms it into an AnswerQuestion object
